...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    $SerialFilterServiceInitializer($$req) {
      return new A._$SerialFilterService$WorkerService();
    },
    SerialFilterService: function SerialFilterService() {
    },
    SerialFilterService_filterSerials_closure: function SerialFilterService_filterSerials_closure(t0) {
      this.upper = t0;
    },
    _extension_0__$getOperations_closure: function _extension_0__$getOperations_closure(t0) {
      this._this = t0;
    },
    _$SerialFilterService$WorkerService: function _$SerialFilterService$WorkerService() {
    },
    ...
    main() {
      A.bootstrap(A.serial_filter_service__$SerialFilterServiceInitializer$closure(), null);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.SerialFilterService.prototype = {
    filterSerials$2(data, serial) {
      return this.filterSerials$body$SerialFilterService(type$.List_String._as(data), serial);
    },
    filterSerials$body$SerialFilterService(data, serial) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_String),
        $async$returnValue, t1;
      var $async$filterSerials$2 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = J.where$1$ax(data, new A.SerialFilterService_filterSerials_closure(serial.toUpperCase()));
      ...
      return A._asyncStartSync($async$filterSerials$2, $async$completer);
    }
  };
  A.SerialFilterService_filterSerials_closure.prototype = {
    call$1(e) {
      return B.JSString_methods.contains$1(A._asString(e), this.upper);
    },
    $signature: 30
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 6;
              return A._asyncAwait($async$self._this.filterSerials$2($$dsr.$$1$1(J.$index$ax(t2._as(t1.$index($$req, 3)), 0)), $$dsr.$$0$1(J.$index$ax(t2._as(t1.$index($$req, 3)), 1))), $async$call$1);
            case 6:
              // returning from await.
              $$res = $async$result;
              $async$next.push(5);
  ...
  A._$SerialFilterService$WorkerService.prototype = {$isWorkerService: 1};
  A._$Deser.prototype = {
    get$$$0() {
    ...
    get$$$1() {
      ...
      if (value === $) {
        t1 = _this.get$$$0();
        result = A.ConverterExt_get_converter(_this).list$1$1(t1, type$.String);
  ...
  (function installTearOffs() {
    ...
    _instance(A._LinkedHashSet.prototype, "get$_newSimilarSet", 0, 0, null, ["call$1$0", "call$0"], ["_newSimilarSet$1$0", "_newSimilarSet$0"], 19, 0, 0);
    ...
    _static_1(A, "serial_filter_service__$SerialFilterServiceInitializer$closure", "$SerialFilterServiceInitializer", 37);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, A.SafeToStringHook, J.ArrayIterator, A.Iterable, A.CastIterator, A.Error, A.SentinelValue, A.ListIterator, A.MappedIterator, A.WhereIterator, A.FixedLengthListMixin, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._SyncStarIterator, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Codec, A.Converter, A._JsonStringifier, A._JsonPrettyPrintMixin, A._BigIntImpl, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.IntegerDivisionByZeroException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A.NullRejectionException, A.CancelationToken, A.LogEvent, A.LogFilter, A.LogOutput, A.LogPrinter, A.Logger, A.OutputEvent, A._WebWorkerChannel, A.WorkerRunner, A.Converter0, A.LazyInPlaceList, A.SerializationContext, A.SquadronException, A.MarshalingContext, A.CancelationTokenReference, A.SerialFilterService]);
    ...
    _inherit(A._$SerialFilterService$WorkerService, A.SerialFilterService);
...
//# sourceMappingURL=serial_filter_service.web.g.dart.js.map
