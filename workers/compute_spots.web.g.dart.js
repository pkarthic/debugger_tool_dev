...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    $ComputeSpotsInitializer($$req) {
      return new A._$ComputeSpots$WorkerService();
    },
    ComputeSpots: function ComputeSpots() {
    },
    _extension_0__$getOperations_closure: function _extension_0__$getOperations_closure(t0) {
      this._this = t0;
    },
    _$ComputeSpots$WorkerService: function _$ComputeSpots$WorkerService() {
    },
    ...
    main() {
      A.bootstrap(A.compute_spots__$ComputeSpotsInitializer$closure(), null);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.$jsify_closure1.prototype = {
    call$1(obj) {
      var t1, cached, jsifier, t2, len, jsArray, i, kjsifier, vjsifier, jsMap, t3, jsSet, res, _this = this;
      if (obj == null)
        return null;
      t1 = _this.cache;
      ...
      if (type$.Map_dynamic_dynamic._is(obj)) {
        ...
        for (t1 = obj.get$entries(), t1 = t1.get$iterator(t1); t1.moveNext$0();) {
          t3 = t1.get$current();
          t2._as(jsMap.set(kjsifier.call$1(t3.key), vjsifier.call$1(t3.value)));
        }
        return jsMap;
      }
      if (type$.Set_dynamic._is(obj)) {
        ...
        for (t1 = obj.get$iterator(obj); t1.moveNext$0();)
          t2._as(jsSet.add(jsifier.call$1(t1.get$current())));
        return jsSet;
      }
  ...
  A.$dartify_closure.prototype = {
    call$1(js) {
      var t1, cached, t2, len, dartList, i, t3, keys, dartMap, t4, t5, entry, t6, values, dartSet, result, res, _this = this, _null = null;
      if (js == null)
        return _null;
      t1 = _this.cache;
      ...
      if (t2) {
        ...
        for (t1 = _this.squadronDartify, t2 = type$.JSArray_nullable_Object, t3 = type$.nullable_JSObject, t4 = t1._name; true;) {
          t5 = t3._as(A.JSObjectUnsafeUtilExtension__callMethod(keys, $.$get$_$JSProps_next(), _null, _null, _null, _null));
          if (t5 == null || !!t5[$.$get$_$JSProps_done()])
            break;
          entry = t2._as(t5[$.$get$_$JSProps_value()]);
          t5 = t1._value;
          if (t5 === t1)
            A.throwExpression(A.LateError$localNI(t4));
          t5 = t5.call$1(entry.at(0));
          t6 = t1._value;
          if (t6 === t1)
            A.throwExpression(A.LateError$localNI(t4));
          dartMap.$indexSet(0, t5, t6.call$1(entry.at(1)));
        }
        return dartMap;
      }
      ...
      if (t2) {
        ...
        for (t1 = _this.squadronDartify, t2 = type$.nullable_JSObject, t3 = t1._name; true;) {
          t4 = t2._as(A.JSObjectUnsafeUtilExtension__callMethod(values, $.$get$_$JSProps_next(), _null, _null, _null, _null));
          if (t4 == null || !!t4[$.$get$_$JSProps_done()])
            break;
          t5 = t1._value;
          if (t5 === t1)
            A.throwExpression(A.LateError$localNI(t3));
          dartSet.add$1(0, t5.call$1(t4[$.$get$_$JSProps_value()]));
        }
        return dartSet;
      }
      if (typeof js === "bigint") {
  ...
  A.ContextAwareConverter.prototype = {
    ...
    list$1$1(cast, $T) {
      ...
      if (J.$eq$(cast, A.instantiate1(A.converter_Converter_identity$closure(), $T)))
        return new A.ContextAwareConverter_list_closure(this, this._converter.list$1$0($T), $T);
      else
  ...
  A.ContextAwareConverter_nmap_closure1.prototype = {
    call$1(x) {
      ...
      t6 = t6._eval$1("MapEntry<1,2?>");
      t2 = A._instanceType(t7);
      ref.addEntries$1(A.MappedIterable_MappedIterable(t7, t2._bind$1(t6)._eval$1("1(Iterable.E)")._as(new A.ContextAwareConverter_nmap__closure(_this.kop, _this.nvop, t4, t5)), t2._eval$1("Iterable.E"), t6));
      return ref;
    },
    $signature() {
      return this.K._eval$1("@<0>")._bind$1(this.V)._eval$1("Map<1,2?>(@)");
  ...
  A.LazyInPlaceMap.prototype = {
    get$entries() {
      var t3,
        t1 = this.$ti,
        t2 = this._lazy_in_place_map$_data.get$keys().cast$1$0(0, t1._precomputed1);
      t1 = t1._eval$1("MapEntry<1,2>");
      t3 = A._instanceType(t2);
      return A.MappedIterable_MappedIterable(t2, t3._bind$1(t1)._eval$1("1(Iterable.E)")._as(new A.LazyInPlaceMap_entries_closure(this)), t3._eval$1("Iterable.E"), t1);
    },
    get$isEmpty(_) {
    ...
    get$keys() {
      return this._lazy_in_place_map$_data.get$keys().cast$1$0(0, this.$ti._precomputed1);
    },
    get$length(_) {
      var t1 = this._lazy_in_place_map$_data;
      return t1.get$length(t1);
    ...
    map$2$1(_, convert, K2, V2) {
      ...
      keys = A.List_List$_of(t2, A._instanceType(t2)._eval$1("Iterable.E"));
  ...
  A.SerializationContext.prototype = {
    getReference$1$1(data, $T) {
      var ref,
        t1 = type$.Object;
      A.checkTypeBound($T, t1, "T", "getReference");
      ref = this._cache.$index(0, t1._as(data));
  ...
  A.ComputeSpots.prototype = {
    computeSpotsInIsolate$1(graphModels) {
      var spotsPerLine, t1, t2, t3, t4, i, data, x, dateTimeMs, t5, posY, curY, velocityStr, velY, _null = null;
      type$.List_Map_String_dynamic._as(graphModels);
      spotsPerLine = A._setArrayType([], type$.JSArray_Map_String_dynamic);
      for (t1 = J.getInterceptor$asx(graphModels), t2 = type$.String, t3 = type$.dynamic, t4 = type$.Map_dynamic_dynamic, i = 0; i < t1.get$length(graphModels); ++i) {
        data = t1.$index(graphModels, i);
        x = data.$index(0, "dateTime");
        if (A._isInt(x))
          dateTimeMs = x;
        else if (x instanceof A.DateTime)
          dateTimeMs = x._core$_value;
        else if (t4._is(x)) {
          t5 = x.$index(0, "millisecondsSinceEpoch");
          dateTimeMs = A._asInt(t5 == null ? Date.now() : t5);
        } else if (typeof x == "string") {
          t5 = A.DateTime_tryParse(x);
          dateTimeMs = t5 == null ? _null : t5._core$_value;
          if (dateTimeMs == null)
            dateTimeMs = Date.now();
        } else
          dateTimeMs = Date.now();
        t5 = data.$index(0, "position");
        t5 = t5 == null ? _null : J.toString$0$(t5);
        posY = A.Primitives_parseDouble(t5 == null ? "0" : t5);
        if (posY == null)
          posY = 0;
        t5 = data.$index(0, "current");
        t5 = t5 == null ? _null : J.toString$0$(t5);
        curY = A.Primitives_parseDouble(t5 == null ? "0" : t5);
        if (curY == null)
          curY = 0;
        t5 = data.$index(0, "velocity");
        velocityStr = t5 == null ? _null : J.toString$0$(t5);
        if (velocityStr != null && velocityStr !== "null" && velocityStr.length !== 0) {
          t5 = A.Primitives_parseDouble(velocityStr);
          velY = t5 == null ? 0 : t5;
        } else
          velY = 0;
        B.JSArray_methods.add$1(spotsPerLine, A.LinkedHashMap_LinkedHashMap$_literal(["dateTime", dateTimeMs, "position", posY, "current", curY, "velocity", velY], t2, t3));
      }
      return spotsPerLine;
    }
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = A._Future$value(t1._as($async$self._this.computeSpotsInIsolate$1($$dsr.$$3$1(J.$index$ax(type$.List_dynamic._as(J.$index$ax($$req, 3)), 0)))), t1);
              $async$goto = 6;
  ...
  A._$ComputeSpots$WorkerService.prototype = {$isWorkerService: 1};
  A._$Deser.prototype = {
    get$$$3() {
      ...
      if (value === $) {
        ...
        result = A.ConverterExt_get_converter(_this).list$1$1(value, type$.Map_String_dynamic);
  ...
  (function installTearOffs() {
    ...
    _instance(A._LinkedHashSet.prototype, "get$_newSimilarSet", 0, 0, null, ["call$1$0", "call$0"], ["_newSimilarSet$1$0", "_newSimilarSet$0"], 11, 0, 0);
    ...
    _static_1(A, "compute_spots__$ComputeSpotsInitializer$closure", "$ComputeSpotsInitializer", 38);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Iterable, A.CastIterator, A.MapBase, A.Closure, A.Error, A.SentinelValue, A.ListIterator, A.MappedIterator, A.WhereIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.LinkedHashMapEntryIterator, A.JSSyntaxRegExp, A._MatchImplementation, A._Cell, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._SyncStarIterator, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.Codec, A.Converter, A._JsonStringifier, A._JsonPrettyPrintMixin, A._BigIntImpl, A.DateTime, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.IntegerDivisionByZeroException, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A.NullRejectionException, A.CancelationToken, A.LogEvent, A.LogFilter, A.LogOutput, A.LogPrinter, A.Logger, A.OutputEvent, A._WebWorkerChannel, A.WorkerRunner, A.Converter0, A.LazyInPlaceList, A.LazyInPlaceMap, A.SerializationContext, A.SquadronException, A.MarshalingContext, A.CancelationTokenReference, A.ComputeSpots]);
    ...
    _inherit(A._$ComputeSpots$WorkerService, A.ComputeSpots);
...
//# sourceMappingURL=compute_spots.web.g.dart.js.map
